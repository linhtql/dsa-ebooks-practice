...
/**
 * Simulation  a Tic-Tac-Toe game (does not do strategy)
 */
public class TicTacToe {
    public static final int X = 1, O = -1;      // players
    public static final int EMPTY = 0;          // empty cell
    private final int[][] board = new int[3][3];      // game board
    ...
    public static void main(String[] args) {
        ...
        int winningPayer = game.winner();
        String[] outcome = {"O wins", "Tie", "X wins"}; //rely on ordering
        System.out.println(outcome[1 + winningPayer]);
